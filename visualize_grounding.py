...
def vis_image(pil_img, json_obj, output_folder):
    image = np.array(pil_img)[:, :, [2, 1, 0]]
    image_h = pil_img.height
    image_w = pil_img.width
    task_obj = json_obj['task_data']
    caption = task_obj['caption']
    ...
    grounding_list = dict(task_obj['groundings'])
...
if __name__ == '__main__':  
    ...
    jsonl_path = 'grit_coyo_100.jsonl'
